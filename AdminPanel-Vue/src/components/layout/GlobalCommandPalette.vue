...
import { buildCommandPaletteSections } from "@/utils/commandPalette";
import type {
  NavigationUsageMap,
  RecentVisit,
...
.command-palette {
  ...
  background:
    radial-gradient(circle at top center, rgba(56, 189, 248, 0.18), transparent 36%),
    rgba(3, 7, 18, 0.72);
...
.command-panel {
  ...
  background:
    ...
    color-mix(in srgb, var(--secondary-bg) 92%, rgba(10, 14, 24, 0.92));
  box-shadow:
...
.command-item.active {
  ...
  background:
    linear-gradient(135deg, rgba(56, 189, 248, 0.12), transparent 62%),
