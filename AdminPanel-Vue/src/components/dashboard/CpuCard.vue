...
.cpu-card {
  --dashboard-accent: var(--cpu-color, #38bdf8);
  --dashboard-accent-soft: rgba(56, 189, 248, 0.18);
  --dashboard-accent-border: rgba(56, 189, 248, 0.34);
}
